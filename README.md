...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bio-embeddings-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15449&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bio-embeddings-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bio-embeddings` can be installed with:

```
conda install bio-embeddings
```

It is possible to list all of the versions of `bio-embeddings` available on your platform with:
